(* Implémentez et testez le tri de fusion. Assurez-vous de comprendre le code
   qui est donné et remplissez tout le code manquant marqué par "TODO" *)

(* Divisé xs en deux parties paires: ys and zs *)
...
let split_alg : string = "TODO: PUT YOUR ANSWER HERE"
